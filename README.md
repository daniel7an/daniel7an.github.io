...
Edit `index.html` for content and `style.css` for appearance. Replace `assets/portrait.jpg` to change the photo. GitHub Pages serves the root of the `main` branch.
